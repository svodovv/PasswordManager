...
fun LoginScreen(
    ...
    if (loginState.userBiometricAnnotation != null) {
        if (loginState.userBiometricAnnotation == true) {
            val myActivity = LocalContext.current as FragmentActivity
            loginViewModel.biometricPromptAuth(myActivity)
